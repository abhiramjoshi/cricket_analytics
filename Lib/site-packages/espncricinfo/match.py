...
from espncricinfo.exceptions import MatchNotFoundError, NoScorecardError, NoJSONData
from codebase.settings import DATA_LOCATION, MATCH_JSONS, HTMLS, ANALYSIS
import os
import pickle
from utils import logger, handle_no_json
    ...
    def get_json(self, try_local=True, save=True, serialize=True):
        ...
        if r.status_code == 404:
            ...
            try:
                ...
                logger.info("Match id %s has no json match object, using HTML only, some fields will not be available") #added
                raise NoJSONData
            if save:
